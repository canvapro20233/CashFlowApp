...
import { APIData } from '../componentSlice/slice';
        ...
        <TouchableOpacity onPress={()=>navigation.navigate("DetailBudget",{data:item})}>
          <View style={{borderWidth:0,height:140,margin:20,borderRadius:20,backgroundColor:"#F1F1FA"}}>
            <View style={{borderWidth:1,borderColor:"#FCFCFC",marginLeft:20,marginTop:20,width:90,height:30,alignItems:'center', justifyContent:'center',borderRadius:10,flexDirection:"row",borderRadius:50}}>
              ...
              {item.category=="Hospital" ? <View style={{borderWidth:0,height:15, width:15,borderRadius:50,marginRight:4,backgroundColor:"#7F3DFF"}}></View> : null}
              {item.category=="Subscription" ? <View style={{borderWidth:0,height:15, width:15,borderRadius:50,marginRight:4,backgroundColor:"#FD3C4A"}}></View> : null}
              {item.category=="Loan" ? <View style={{borderWidth:0,height:15, width:15,borderRadius:50,marginRight:4,backgroundColor:"#FD3C4A"}}></View> : null}
              {item.category=="Travel" ? <View style={{borderWidth:0,height:15, width:15,borderRadius:50,marginRight:4,backgroundColor:"#FD3C4A"}}></View> : null}
